...
- Match product_id when the line is the same product as a catalog entry, even if the printed name differs (abbreviations, language, brand + generic name, or a listed alias). Otherwise 0 and set product_name.
