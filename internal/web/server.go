...
func (s *Server) routes() {
	...
	s.engine.GET("/admin/retail-chains", s.retailChains)
	s.engine.GET("/admin/retail-chains/new", s.newRetailChain)
	s.engine.POST("/admin/retail-chains", s.createRetailChain)
	s.engine.GET("/admin/retail-chains/:id/edit", s.editRetailChain)
	s.engine.POST("/admin/retail-chains/:id", s.updateRetailChain)
	s.engine.GET("/admin/retail-chains/:id/delete", s.confirmDeleteRetailChain)
	s.engine.POST("/admin/retail-chains/:id/delete", s.deleteRetailChain)

	s.engine.GET("/admin/stories", s.stories)
	s.engine.GET("/admin/stories/new", s.newStory)
	s.engine.POST("/admin/stories", s.createStory)
	s.engine.GET("/admin/stories/:id/edit", s.editStory)
	s.engine.POST("/admin/stories/:id", s.updateStory)
	s.engine.GET("/admin/stories/:id/delete", s.confirmDeleteStory)
	s.engine.POST("/admin/stories/:id/delete", s.deleteStory)
